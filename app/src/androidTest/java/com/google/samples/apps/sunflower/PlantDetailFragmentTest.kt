...
class PlantDetailFragmentTest {
    ...
    @Rule
    @JvmField
    val activityTestRule = createAndroidComposeRule<GardenActivity>()
    ...
    fun jumpToPlantDetailFragment() {
        ...
        activityTestRule.activityRule.scenario.onActivity { gardenActivity ->
    ...
    @Test
    fun testPlantName() {
        activityTestRule.onNodeWithText("Apple").assertIsDisplayed()
    }
